...
RegisterServerEvent('esx_goldminer:GiveItem')
AddEventHandler('esx_goldminer:GiveItem', function()
	...
	if Quantity >= 15 then
		...
		TriggerClientEvent('esx:showNotification', _source, 'You have mined some gold.')
	end
end
)
...
RegisterServerEvent('esx_goldminer:startSale')
AddEventHandler('esx_goldminer:startSale', function()
...
RegisterServerEvent('esx_goldminer:stopSale')
AddEventHandler('esx_goldminer:stopSale', function()
